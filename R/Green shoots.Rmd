...
#### Figure 2 Trend in severity of symptoms among Australian young people  
...
The K6 consists of six items, each of which deals with either depressive or anxiety symptoms. Examining the trends in each item reveals which set of symptoms are responsible for the recent changes in psychological distress.  


\newpage

#### Figure 3 Annual trends in life satisfaction, self-rated mental health and feelings about the future  
...
Apart from the K6, the Mission Australia Youth Survey has a number of other mental health & wellbeing measures. Questions concerning life satisfaction, feelings about the future, and judgments of one’s own mental health. These represent different facets of wellbeing which can indicate trends in wellbeing beyond anxiety and depression symptoms.  

\newpage  


#### Figure 4. Sociodemographic differences in psychological distress  
```{r figure_4, fig.dim=c(6.42, 6), fig.cap=""}
source("figure_4.R")
...
The National Action Plan describes health inequity as the disparity in health outcomes for children and young people across Australia, with particular populations at greater risk. These inequities often appear early and increase along a clear social gradient, widening the health gap between the most and least disadvantaged as the life course progresses.  

> "Health inequity stems in large part from a series of social and other determinants, such as location, socio-economic status, housing, parental education, and access to resources. Many of these are co-related and children and young people are often exposed to multiple determinants which compound their inequity.”  

The Mission Australia Youth Survey identifies many of the Action Plan’s priority populations including: 1) Aboriginal and Torres Strait Islander children and young people; 2) Children and young people from culturally and linguistically diverse backgrounds 3) Children and young people living with disability and chronic conditions.  

Other populations with higher rates of poor mental health also include those who report: 4) Experiencing unfair treatment in the last year (Discriminated); 5) Gender diverse (Diverse); 6) Female gender.  

Mental health inequity was found in all six priority populations. The prevalence of high distress was substantially greater among young people identifying as gender diverse (+36 percentage points over other young people in 2024), or disabled (+21 percentage points over others in 2024) or experiencing discrimination (+26.7 percentage points over others in 2024).  

Thus while the prevalence of high distress has declined after 2022, we found no evidence that mental health inequity has improved for any group over the last decade, as there was little or no change in the gap in that period. This suggests the improvements in psychological distress trends do not demonstrate any change in the underlying causes of mental health inequity.  
